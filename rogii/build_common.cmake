...
set(
    PACKAGE_NAME
    "clipper2-${ROGII_PKG_VERSION}-${ARCH}-${BUILD}${TAG}"
)
...
execute_process(
    COMMAND
        "${CMAKE_COMMAND}" -G Ninja -DCMAKE_BUILD_TYPE=Debug -DCMAKE_DEBUG_POSTFIX=d ${COMMON_BUILD_OPT} -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX} ../../CPP
    WORKING_DIRECTORY
        "${DEBUG_PATH}"
)
...
execute_process(
    COMMAND
        "${CMAKE_COMMAND}" -G Ninja -DCMAKE_BUILD_TYPE=RelWithDebInfo ${COMMON_BUILD_OPT} -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX} ../../CPP
    WORKING_DIRECTORY
        "${RELEASE_PATH}"
)
